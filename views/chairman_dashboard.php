...
$sql2 = "SELECT 
        ...
        WHERE  a.application_status IN ('DIRECTOR_APPROVED') 
            AND a.location = 'international'
            ...
            <?php if ($result2->num_rows > 0): ?>
                <?php while ($row = $result2->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars(substr($row['location'], 0, 30)); ?>
                            <?= strlen($row['location']) > 30 ? '...' : ''; ?>
                        </td>
                        ...
                        <td>
                            <a href="chairman_view_applications.php?application_id=<?= $row['application_id']; ?>&type=event" class="btn-view">View & Review</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
