...
// Redirect if not dfw_da
if ($_SESSION['role'] !== 'dfw_da') {
...
$sql1 = "SELECT * FROM cpda_applications 
        WHERE current_stage IN ('DA_REVIEW') 
...
$sql2 = "SELECT 
        ...
        WHERE  a.current_stage IN ('DA_REVIEW')
...
<div class="container">
    ...
    <div class="header-info">
        ...
        <strong>Role:</strong> Dealing Assistant (Dean Office)
    </div>
            ...
            <?php if ($result1->num_rows > 0): ?>
                <?php while ($row = $result1->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="dfw_da_view_application.php?application_id=<?= $row['application_id']; ?>&type=form1" class="btn-view">View</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
            ...
            <?php if ($result2->num_rows > 0): ?>
                <?php while ($row = $result2->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="dfw_da_view_application.php?application_id=<?= $row['application_id']; ?>&type=event" class="btn-view">View & Review</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
