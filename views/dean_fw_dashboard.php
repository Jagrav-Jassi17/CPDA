...
$sql1 = "SELECT * FROM cpda_applications 
        WHERE current_stage IN ('DFW_REVIEW') 
...
$sql2 = "SELECT 
        ...
        WHERE  a.current_stage IN ('DFW_REVIEW')
...
<div class="container">
    ...
    <div class="header-info">
        ...
        <strong>Role:</strong> Dean Faculty Welfare
    </div>
            ...
            <?php if ($result1->num_rows > 0): ?>
                <?php while ($row = $result1->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="dean_fw_view_application.php?application_id=<?= $row['application_id']; ?>&type=form1" class="btn-view">View</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
            ...
            <?php if ($result2->num_rows > 0): ?>
                <?php while ($row = $result2->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="dean_fw_view_application.php?application_id=<?= $row['application_id']; ?>&type=event" class="btn-view">View & Review</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
