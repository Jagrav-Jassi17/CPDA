...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if (!empty($user_message)) {
        ...
        // message prefix
        $prefix = match ($action) {
            'recommend' => '[DA-RECOMMENDED]',
            'not_recommend' => '[DA-REJECTED]',
            default => '[DA-SEND-BACK]'
        };
    ...
    /* -------------------------------------------------------
       Redirect
    ------------------------------------------------------- */
    header("Location: dfw_da_dashboard.php?msg=Action completed");
    exit();
}
