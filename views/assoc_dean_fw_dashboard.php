...
$sql1 = "SELECT * FROM cpda_applications 
        WHERE current_stage IN ('ASS_REVIEW') 
...
$sql2 = "SELECT 
        ...
        WHERE  a.current_stage IN ('ASS_REVIEW')
            ...
            <?php if ($result1->num_rows > 0): ?>
                <?php while ($row = $result1->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="assoc_dean_fw_view_applications.php?application_id=<?= $row['application_id']; ?>&type=form1" class="btn-view">View</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
            ...
            <?php if ($result2->num_rows > 0): ?>
                <?php while ($row = $result2->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td>
                            <a href="assoc_dean_fw_view_applications.php?application_id=<?= $row['application_id']; ?>&type=event" class="btn-view">View & Review</a>
                        </td>
                    </tr>
                <?php endwhile; ?>
            <?php else: ?>
